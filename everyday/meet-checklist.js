...
t = {
    ...
    PT: ["Apresenta\xe7\xe3o (Nome e Time)", "A ligação poderá ser gravada para fins de treinamento e qualidade de acordo com a nossa política de privacidade", "Tempo da Liga\xe7\xe3o", "Confirma\xe7\xf5es: Task, site, AM", "Confirma\xe7\xe3o: Pedir que o Anunciante Confirme os 10 d\xedgitos do CID", "Confirma\xe7\xe3o: Backup e acessos ADM", "Fechar Conte\xfado Sens\xedvel", "Resumo da chamada", "Ajuda adicional", "Fechar compartilhamento de tela", "Pr\xf3ximos passos (quanto tempo vai acompanhar o caso)", "Pesquisa de Satisfa\xe7\xe3o"],



    ES: ["Presentaci\xf3n (Nombre y Equipo)", "La llamada puede ser grabada con fines de entrenamiento y calidad de acuerdo con nuestra politica de privacidad.", "Tiempo de duraci\xf3n de la llamada", "Confirmaciones: Task, sitio web, nombre del AM", "Confirmaci\xf3n: confirme los 10 digitos del CID", "Confirmaci\xf3n: Copia de seguridad/backup y acceso ADM/FTP", "Cerrar contenido sensible antes de compartir la pantalla", "Resumen de la llamada", "Ayuda adicional", "Finalizar el uso de la pantalla compartida", "Pr\xf3ximos pasos (cu\xe1ntos d\xedas le dar\xe1s seguimiento)", "Encuesta de satisfacci\xf3n"],



    EN: ["Introduction (Name and Team)", "Call Duration: Record the duration of the call.", "Confirmations: Task, Website URL, AM's name", "Confirmation: Ask the advertiser to confirm the 10 digits CID.", "Confirmation: Inform about recording the call.", "Confirmation: advertiser agrees to the terms and conditions.", "Confirmation: Website Backup and Admin/FTP panel", "Close Sensitive Content", "Call Summary", "Additional Assistance.", "Close Screen Share: End screen sharing.", "Next Steps(follow up n\xba of days)", "Satisfaction Survey"]
...
}), console.log("bookmark start"), (window.location.href.includes("meet.google.com") || window.location.href.includes("127.0.0.1")) && (window.location.href.includes("meet.google.com") || window.location.href.includes("127.0.0.1")) && function e(a) {
